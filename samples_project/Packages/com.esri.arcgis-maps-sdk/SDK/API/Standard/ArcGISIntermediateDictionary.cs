...
namespace Esri.Standard
{
    ...
    internal partial class ArcGISIntermediateDictionary<Key, Value>
    {
        ...
        /// </summary>
        internal Unity.ArcGISImmutableArray<Key> Keys
        {
            get
            {
                var errorHandler = Unity.ArcGISErrorManager.CreateHandler();
                ...
                Unity.ArcGISImmutableArray<Key> localLocalResult = null;
                
                if (localResult != IntPtr.Zero)
                {
                    localLocalResult = new Unity.ArcGISImmutableArray<Key>(localResult);
                }
