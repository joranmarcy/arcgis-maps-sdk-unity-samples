...
namespace Esri.Standard
{
    ...
    /// 
    /// An executing <see cref="Standard.ArcGISIntermediateFuture<T>">ArcGISIntermediateFuture<T></see> can be requested to cancel by calling <see cref="Standard.ArcGISIntermediateFuture<T>.Cancel">ArcGISIntermediateFuture<T>.Cancel</see>. If the cancellation is
    /// observed by the executing code, then the <see cref="Standard.ArcGISIntermediateFuture<T>">ArcGISIntermediateFuture<T></see> returns an <see cref="Standard.ArcGISError">ArcGISError</see> from <see cref="Standard.ArcGISIntermediateFuture<T>.GetError">ArcGISIntermediateFuture<T>.GetError</see>.
    /// </remarks>
    ...
    internal partial class ArcGISIntermediateFuture<T>
    {
        #region Methods
        /// <summary>
        /// Request cancellation of the <see cref="Standard.ArcGISIntermediateFuture<T>">ArcGISIntermediateFuture<T></see>.
        /// </summary>
        /// <remarks>
        /// Cancellation is a cooperative mechanism. Cancel can be called on the <see cref="Standard.ArcGISIntermediateFuture<T>">ArcGISIntermediateFuture<T></see>, but the
        /// executing code must also periodically check for cancellation and terminate. It is possible
        /// that a canceled <see cref="Standard.ArcGISIntermediateFuture<T>">ArcGISIntermediateFuture<T></see> could still complete successfully, if cancel was called after
        /// the executing code checked for cancellation. 
        /// Once cancel is called, <see cref="Standard.ArcGISIntermediateFuture<T>.IsCanceled">ArcGISIntermediateFuture<T>.IsCanceled</see> will return true.
        ...
        /// </remarks>
        /// <returns>
        /// true if the <see cref="Standard.ArcGISIntermediateFuture<T>">ArcGISIntermediateFuture<T></see> was requested to cancel, false if the <see cref="Standard.ArcGISIntermediateFuture<T>">ArcGISIntermediateFuture<T></see> had already been
        /// requested to cancel.
        ...
        /// 
        /// If the <see cref="Standard.ArcGISIntermediateFuture<T>">ArcGISIntermediateFuture<T></see> terminated due to a cancellation request, this is also a failure and returns an error.
        /// </remarks>
        /// <returns>
        ...
        /// <summary>
        /// Indicates if the <see cref="Standard.ArcGISIntermediateFuture<T>">ArcGISIntermediateFuture<T></see> has been requested to cancel.
        /// </summary>
        /// <returns>
        /// true if the <see cref="Standard.ArcGISIntermediateFuture<T>">ArcGISIntermediateFuture<T></see> has been requested to cancel or false otherwise.
        /// </returns>
