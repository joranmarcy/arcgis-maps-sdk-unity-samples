...
namespace Esri.Standard
{
	...
	internal partial class ArcGISElement
	{
		...
		internal static ArcGISElement FromArcGISAuthenticationConfiguration(Esri.GameEngine.Security.ArcGISAuthenticationConfiguration value)
		{
			...
			var localResult = PInvoke.RT_Element_fromGEAuthenticationConfiguration(localValue, errorHandler);
	...
	internal static partial class PInvoke
	{
		...
		[DllImport(Unity.Interop.Dll)]
		internal static extern IntPtr RT_Element_fromGEAuthenticationConfiguration(IntPtr handle, IntPtr errorHandler);
