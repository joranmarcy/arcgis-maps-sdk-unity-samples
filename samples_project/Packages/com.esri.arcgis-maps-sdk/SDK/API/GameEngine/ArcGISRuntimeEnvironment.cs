...
namespace Esri.GameEngine
{
    ...
    public partial class ArcGISRuntimeEnvironment
    {
        ...
        /// 
        /// In addition to setting an <see cref="GameEngine.ArcGISRuntimeEnvironment.APIKey">ArcGISRuntimeEnvironment.APIKey</see> at a global level for your application, you
        /// can set it on any class that implements <see cref="">APIKeyResource</see>. This overrides the
        /// <see cref="GameEngine.ArcGISRuntimeEnvironment.APIKey">ArcGISRuntimeEnvironment.APIKey</see> and enables more granular usage telemetry and management of ArcGIS
