...
namespace Esri.GameEngine.Geometry
{
    ...
    /// </summary>
    /// <remarks>
    /// These values can be used to create instances of <see cref="GameEngine.Geometry.ArcGISAngularUnit">ArcGISAngularUnit</see>, as an alternative to using well-known IDs (WKIDs).
