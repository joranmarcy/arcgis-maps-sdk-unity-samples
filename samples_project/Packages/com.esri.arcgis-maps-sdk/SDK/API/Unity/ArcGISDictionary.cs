...
{
	public class ArcGISDictionary<TKey, TValue>
	{
		private Standard.ArcGISIntermediateDictionary<TKey, TValue> intermediateDictionary;
		...
		public Unity.ArcGISImmutableArray<TKey> Keys
		{
			get
			{
				return intermediateDictionary.Keys;
			}
		}
		...
		public ArcGISDictionary()
		{
			intermediateDictionary = new Standard.ArcGISIntermediateDictionary<TKey, TValue>(Esri.Unity.Convert.ToArcGISElementType<TKey>(), Esri.Unity.Convert.ToArcGISElementType<TValue>());
		}

		internal ArcGISDictionary(IntPtr handle)
		{
			intermediateDictionary = new Standard.ArcGISIntermediateDictionary<TKey, TValue>(handle);
		}
